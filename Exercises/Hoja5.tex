...
\end{enumerate}
    ...
    \begin{enumerate}
        ...
        \end{cases}
        \]
        \item[(iii)] Tenemos que la carta afín $U$ está dada por $H_\infty : x_0 + x_2 = 0$, luego en la carta afín tenemos $x_2 = -x_0$. Entonces, sustituyendo en las ecuaciones de la recta $\tilde{r}$:
        \[
        r = \tilde{r} \cap U :
        \begin{cases}
            2x'_1 + x'_2 = 1 \\
...
Sean $P = (1 : 0 : 0)$, $Q = (0 : 0 : 1)$ y $r : x_0 + x_1 + x_2 = 0$. En el plano afín $\mathbb{P}^2_{\mathbb{R}} \setminus r$ se considera la traslación $g$ que transforma $P$ en $Q$. Calcula la imagen por $g$ del punto $(1 : 0 : 1)$.
    ...
    \]
    Otra forma de hacerlo, es aplicar que $g(B) = B \quad \forall B \in r$ y $g(P) = Q$.
}
