...
\begin{enumerate}
    ...
    \[
        \dim(f(X \setminus Z)) = \dim X - \dim(X \cap Z) - 1 = \dim X - [\dim(X \cap Z) + 1] \implies \dim(f(X \setminus Z)) \leq \dim(X) \text{ y } \dim(f(X \setminus Z)) = \dim(X) => \dim(X) \iff \dim(X \cap Z) = \emptyset \iff f |_X \text{ inyectiva}
    \] 
