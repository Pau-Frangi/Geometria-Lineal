...
Si $rg(M(\varphi)_{\mathfrak{R}}) = 0 \implies$ no es una cuadrica.\\
Si $rg(M(\varphi)_{\mathfrak{R}}) = 1 \implies M = \begin{pmatrix}
    1 & 0 \\
    0 & 0
\end{pmatrix} \implies C_\varphi : x_0^2 = 0 \implies C_\varphi = \{ (0 : 1) \}$ (punto doble).\\
Si $rg(M(\varphi)_{\mathfrak{R}}) = 2 \implies M = \begin{pmatrix}
    1 & 0 \\
    0 & 1
