...
Por lo tanto, la asignación de unas coordenadas a un punto proyectivo $(u_0, u_1, u_2) \to A$ es adecuada entendiendo las coordenadas salvo proporcionalidad.

\begin{definición} [Referencias proyectivas]
    Una referencia proyectiva denotada por $\mathfrak{R}$ de un espacio proyectivo $\mathbb{P}$ de un espacio de dimensión $n$ es un conjunto de $n+2$ puntos $A_0, A_1, \ldots, A_n; A_{n+1}$ tales que cualesquiera $n+1$ puntos forman un conjunto de puntos proyectivamente independientes.\\
    Al punto $A_{n+1}$ se le llama punto unidad.
\end{definición}
