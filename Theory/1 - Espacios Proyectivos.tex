...
\begin{proof}
    Sean $r_1, r_2$ dos rectas proyectivas de $P$, entonces:
    \[
...
\ejemplo{
    ...
    \]
    De forma alternativa, se puede definir si $\mathfrak{R}$ es referncia calulando su base asociada $\mathcal{B}$.
    \[
