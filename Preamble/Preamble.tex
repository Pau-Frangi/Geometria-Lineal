...
\usepackage{tikz}
\usetikzlibrary{3d,calc,arrows.meta,decorations.pathreplacing,intersections,backgrounds,shapes,positioning,patterns,math}
\usepackage{tikz-3dplot}
\usepackage{pgfplots}
\pgfplotsset{compat=1.15}
...
\fancyfoot[R]{\footnotesize{%
  \href{https://github.com/Pau-Frangi}{Pau F.}\ y \ 
  \href{https://github.com/DIEGOROCU}{Diego R.}
}}
